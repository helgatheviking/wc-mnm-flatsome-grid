...
?>
<div class="mnm_image <?php echo function_exists( 'flatsome_product_box_image_class' ) ? flatsome_product_box_image_class() : '';?>">
	 ...
	 * @param $size
	 */
	$image_size = apply_filters( 'woocommerce_mnm_product_thumbnail_size', 'woocommerce_thumbnail' );
	?>
